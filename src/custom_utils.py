...
def plot_learning_curve(estimator, X, y, cv=None, scoring=None, figsize=None):
    ...
    train_sizes, train_scores, test_scores, fit_times, _ = learning_curve(estimator, X, y, return_times=True)
...
def plot_validation_curve(estimator, X, y, scoring=None, 
    # param_range=param_range, fig_size=fig_size
    ):
